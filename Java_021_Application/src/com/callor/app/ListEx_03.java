...
//			scoreList.add(scoreVO);
			...
			ScoreVO scoreVO
				= new ScoreVO(strNum, intKor, intEng, intMath, intEng, intMath);
	...
	public static void printScore(List<ScoreVO> scList) {
		...
		for(ScoreVO vo : scList) {
			...
			System.out.printf(vo.getStrNum() + "\t");
			System.out.printf(vo.getEng() + "\t");
			System.out.printf(vo.getKor() + "\t");
			System.out.printf(vo.getMath() + "\t");
			System.out.printf(vo.getTotal() + "\t");
			System.out.printf(vo.getAvg() + "\n");

 ...
 *  
 *  	하지만 단순히 상속받는것 만으로 객체지향의 특징을
 *  	잘 나타낸다고 할 수 없다.
 *  
 *  	객체지향에서 상속은 단순히 코드를 이어받아
 *  	사용하는 것 뿐만이 아니고 이미 만들어진 method를
 *  	사용하면서 필요에 따라 일부 method를 나만의 방식으로
 *  	변경(확장)하여 작성할 수 있다
 *  
 ...
 *  
 *  	==> 코드의 재사용 장점 이라고 하기도 한다.
 */
public class EvenServiceV3A extends EvenServiceV2{

...
public class NumberEx_01 {
	...
	public static void main(String[] args) {
		...
		// 정수 31과 29를 전달하고
		// 그 결과를 retNum 변수에 담아라(저장)
		Integer retNum = nsV1.addNum(31, 29);
		if(retNum == null) { // null => 짝수가아닐경우
		...
		System.out.println(retNum1); // null
		...
		// 매개변수형식과 일치하는 method를 찾아서
		// 연결해 준다
		// public Float addNum(int num1, int num2)가 호출됨
		nsV1.addNum(30, 40);
		
		// public Float addNum(float num1, float num2)가 호출됨
		nsV1.addNum(30f, 40f);
	}

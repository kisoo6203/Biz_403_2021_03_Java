...
public class Method_01 {
	...
	public static void main(String[] args) {
		 ...
		 */
		String str1 = new String(); // 저장되는값이 "" 빈칸
		String str2 = new String("대한민국"); // 매개변수 유무 문제없음
		String str3 = "우리나라";
		
		/*
		 *  int형 변수와 Integer wrapper를 사용하여 만든 변수
		 *  사용하는 기본방법은 동일하다
		 ...
		 *  	만들지 말자!!!
		 */
		// Integer int1 = new Integer(); 사용 금지
		Integer int1 = 30;

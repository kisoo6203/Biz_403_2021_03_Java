...
public class InputNumberV1 {
	...
	/*
	 * Scanner class는 키보드 자원을 연동하여 키보드로부터 값을 입력받기위한 클래스이다 이 클래스는 컴퓨터의 자원을 사용하는 관리가
	 * 매우 엄격하게 필요한 클래스이다 사용하는 방법에 따라, 오류가 발생하거나 심지어 컴퓨터 시스템이 멈추는 현상까지 발생할 수 있다 이러한
	 * 클래스는 사용할 때 상당한 주의가 필요하다
	 */
	// Scanner클래스를 main() method가 아닌Service 등의 클래스에서

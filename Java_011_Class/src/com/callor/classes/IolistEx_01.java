...
public class IolistEx_01 {
	 ...
	 *   		IolistEx_01.main("alkdjfag")를 호출하여
	 *   		코드를 실행하기 시작한다
	 */
	public static void main(String[] args) {
		 ...
		 *  4. 맴버변수에 값을 저장할 때 setter method를
		 *  	통해서 저장을 해야한다
		 */
		IolistVOA iolistVOA = new IolistVOA();
		
		iolistVOA.setPname("신라면");
		iolistVOA.setDate("2021-03-31");
		iolistVOA.setDname("농심");
		iolistVOA.setInout("매입");
		iolistVOA.setIprice(500);
		iolistVOA.setQty(100);
		
		printIolist(iolistVOA);
	}
	public static void printIolist(IolistVOA iolistVOA) {
		
		System.out.println("===================================================");
		System.out.println("상품명\t일자\t\t거래처\t구분\t수량\t단가");
		System.out.println("---------------------------------------------------");
		System.out.print(iolistVOA.getPname() + "\t");
		System.out.print(iolistVOA.getDate() + "\t");
		System.out.print(iolistVOA.getDname() + "\t");
		System.out.print(iolistVOA.getInout() + "\t");
		System.out.print(iolistVOA.getQty() + "\t");
		System.out.print(iolistVOA.getIprice() + "\n");
